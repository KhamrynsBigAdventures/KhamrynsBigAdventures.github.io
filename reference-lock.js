...
(function(){
  function apply(){
    ...
    s.textContent=`
      .site-header{background:linear-gradient(145deg,#057F95,#20AAAC)!important;border:3px solid #FFD84A!important;color:#fff!important}
      .site-header a{color:#fff!important}.site-header .brand-star{color:#FFD84A!important}
      ...
      .book-card,.connect-card{background:linear-gradient(145deg,#057F95 0%,#068C9D 52%,#20AAAC 100%)!important;border:3px solid rgba(255,216,74,.94)!important}
      .book-card h3,.book-card p,.connect-card h2,.connect-card p{color:#fff!important}
      .book-art{background:rgba(32,170,172,.20)!important}
      ...
      .button-gold,.button,.button-gold:visited{background:#FFD84A!important;color:#064682!important;border:3px solid #FFD84A!important}
      .button-outline{background:rgba(142,195,158,.20)!important;color:#fff!important;border:2px solid #FFD84A!important}
    `;
