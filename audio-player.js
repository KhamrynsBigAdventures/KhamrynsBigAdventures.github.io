...
(function(){
  // Use the real uploaded MP3 in the repository root.
  ...
  play.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();if(audio.paused)startMusic();else audio.pause()});
  audio.addEventListener('play',updateButton);
  audio.addEventListener('pause',updateButton);
  audio.addEventListener('error',()=>{play.textContent='▶ Play';play.title='Soundtrack could not be loaded.'});
