...
(function(){
  ...
  style.textContent = `
    ...
    #khamryn-music button{width:100%;height:100%;padding:0;border:0;border-radius:50%;background:transparent;color:#ffd447;font-size:30px;line-height:1;cursor:pointer;display:grid;place-items:center;text-shadow:0 2px 8px rgba(0,0,0,.35);transition:transform .18s ease,filter .18s ease}
    #khamryn-music button:hover{transform:scale(1.06);filter:brightness(1.08)}
    #khamryn-music button:active{transform:scale(.94)}
    #khamryn-music.playing{box-shadow:0 10px 28px rgba(0,0,0,.35),0 0 34px rgba(255,212,71,.42)}
